...
const I18N = {
  RU: {
    ...
    contactsModalTitle: "Контакты и обратная связь",
    ...
    officialDevsTitle: "🎮 Официальные контакты разработчиков игры",
    officialDevsDesc: "По вопросам официальной поддержки игры, восстановления игрового аккаунта, багов в игре и платежей (ChillyRoom):",
    copyBtn: "Копировать",
  ...
  EN: {
    ...
    contactsModalTitle: "Contacts & Feedback",
    ...
    officialDevsDesc: "For official in-game support, account recovery, in-game bug reports, and purchase issues:",
    copyBtn: "Copy",
    copiedBtn: "Copied! ✓",
    openLink: "Open",
  ...
  CN: {
    ...
    contactsBtn: "💬 联系方式",
    contactsModalTitle: "联系方式与反馈",
    siteCreatorTitle: "🛠️ 网站作者与维护者",
    siteCreatorDesc: "关于本图鉴网站的建议反馈、Bug报告、功能提议及数据库更新：",
    officialDevsTitle: "🎮 官方游戏开发者联系方式 (ChillyRoom)",
    officialDevsDesc: "关于游戏内账号恢复、游戏内Bug以及充值等官方技术支持问题：",
    copyBtn: "复制",
    copiedBtn: "已复制！✓",
    openLink: "打开",
